...
public class hanghoa extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblhanghoa.setBackground(new java.awt.Color(255, 255, 255));
        tblhanghoa.setForeground(new java.awt.Color(51, 51, 55));
        tblhanghoa.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Tên SP", "Loại", "Ram", "Pin", "Rom", "Màn Hình", "SL", "Tồn Kho", "Giá"
            }
        ));
        tblhanghoa.setGridColor(new java.awt.Color(0, 0, 153));
        tblhanghoa.setSelectionBackground(new java.awt.Color(0, 102, 255));
        tblhanghoa.setSelectionForeground(new java.awt.Color(51, 204, 255));
        jScrollPane1.setViewportView(tblhanghoa);

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 153));
        jLabel3.setText("Bộ nhớ");

        jComboBox1.setBackground(new java.awt.Color(255, 255, 255));
        jComboBox1.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jComboBox1.setForeground(new java.awt.Color(0, 0, 153));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "32 GB", "64 GB", "128 GB", "256 GB", "512 GB", "1 TB" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "4,7 inch - 5,2 inch", "5,5 inch - 6 inch", "6,1 inch - 6,4 inch", "6,5 inch - 7 inch" }));

        jComboBox3.setBackground(new java.awt.Color(255, 255, 255));
        jComboBox3.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jComboBox3.setForeground(new java.awt.Color(0, 0, 153));
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Apple", "Samsung", "Huawei", "Xiaomi", "Realme", "Nokia" }));
        ...
        jComboBox8.setForeground(new java.awt.Color(0, 0, 153));
        ...
        jComboBox9.setForeground(new java.awt.Color(0, 0, 153));
        jComboBox9.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jComboBox10.setBackground(new java.awt.Color(255, 255, 255));
        jComboBox10.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        jComboBox11.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jComboBox11.setForeground(new java.awt.Color(0, 0, 153));
        jComboBox11.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jComboBox12.setBackground(new java.awt.Color(255, 255, 255));
        jComboBox12.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        jTextField2.setText("IPhone 15 Pro");
        ...
        jSeparator4.setPreferredSize(new java.awt.Dimension(5, 5));
        ...
        jTextArea1.setText("ngu như chó");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jComboBox12, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTextField5.setText("bdjabfjla");
        jTextField5.setBorder(null);

        jSeparator5.setBackground(new java.awt.Color(0, 0, 153));
        jSeparator5.setForeground(new java.awt.Color(0, 0, 153));

        tblhanghoa1.setBackground(new java.awt.Color(255, 255, 255));
        tblhanghoa1.setForeground(new java.awt.Color(51, 51, 55));
        ...
        tblhanghoa1.setGridColor(new java.awt.Color(0, 0, 153));
        tblhanghoa1.setSelectionBackground(new java.awt.Color(0, 102, 255));
        tblhanghoa1.setSelectionForeground(new java.awt.Color(51, 204, 255));
