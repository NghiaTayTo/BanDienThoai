...
public class HoaDonUI extends javax.swing.JPanel {
   ...
   void fillTablehoadon() {
     ...
     void fillTablesanpham() {
        DefaultTableModel model = (DefaultTableModel) tblsapphamq.getModel();
        model.setRowCount(0);
        List<Object[]> list = dao.getsanphamq();
        for (Object[] row : list) {
            model.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        tblsapphamq = new javax.swing.JTable();
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hiện tại", " " }));
        ...
        tblhoadon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Khách hàng", "Sđt KH", "Mã NV", "Ngày tạo", "SL", "Tổng tiền hàng", "Phí vận chuyển", "Giảm theo hóa đơn", "Tổng tiền hóa đơn", "Ghi chú"
            }
        ));
        ...
        tblsapphamq.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Tên SP", "Giá bán", "Sale/1 SP", "SL", "Thành tiền"
            }
        ));
        jScrollPane3.setViewportView(tblsapphamq);
        ...
        jLabel10.setText("Chọn IMEI máy muốn đổi");
    ...
    private javax.swing.JTable tblsapphamq;
