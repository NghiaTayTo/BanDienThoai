...
public class LogIn extends javax.swing.JFrame {
    ...
    boolean check() {
        if (txtTen.getText().isEmpty() || txtPass.getText().isEmpty()) {
            MsgBox.alert(this, "Các trường không được để trống.");
            return false;
        }
        return true;
    }
    ...
    void dangNhap() {
        ...
        KhachHang kh = dao.selectByTenDangNhap(tenDn);
        if (kh != null) {
            if (tenDn.equals(kh.getTenDangNhap())) {
                if (pass.equals(kh.getMatKhau())) {
                    this.dispose();
                    MainBanHang main = new MainBanHang();
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtTen, javax.swing.GroupLayout.DEFAULT_SIZE, 332, Short.MAX_VALUE)
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        this.dispose();
        VaiTroMain main = new VaiTroMain();
        main.setVisible(true);
